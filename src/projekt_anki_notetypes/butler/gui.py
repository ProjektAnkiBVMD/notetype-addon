...
class FirstSetupConfigDialog(QDialog):
    def __init__(self, parent, helper):
        ...
        # Explanatory text
        info_label = QLabel("Neu bei Ankizin? Herzlich Willkommen! Aller Anfang ist schwer, und um dein Leben etwas leichter zu machen kannst du hier ein paar Einstellungen automatisch vornehmen lassen.")
        ...
        self.deck_cb = QCheckBox("Empfohlene Einstellungen übernehmen (Sinnvoll, wenn du neu bei Anki bist)")
        ...
        right_layout.addWidget(confirm_btn, alignment=Qt.AlignmentFlag.AlignHCenter)
...
class UpdateConfigDialog(QDialog):
    def __init__(self, parent, helper):
        ...
        # Explanatory text
        info_label = QLabel("Frisch eine neue Version von Ankizin heruntergeladen? Hier kannst du einige Aufräumarbeiten automatisch erledigen lassen.")
        info_label.setWordWrap(True)
        right_layout.addWidget(info_label)
