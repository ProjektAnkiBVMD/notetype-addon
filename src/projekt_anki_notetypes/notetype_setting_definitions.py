...
setting_configs: Dict[str, Any] = OrderedDict(
    {
        ...
        "front_divi_format": {
            "text": "Medikationen nach DIVI-Standard der auf der Vorderseite verwenden",
            "tooltip": "",
            "type": "checkbox",
            "file": "front",
            "regex": r"var +diviformatting += +(false|true)",
            "section": "Layout",
            "default": False,
        },
        "back_divi_format": {
            "text": "Medikationen nach DIVI-Standard der auf der Rückseite verwenden",
            "tooltip": "",
            "type": "checkbox",
            "file": "back",
            "regex": r"var +diviformatting += +(false|true)",
