...
Dieses AddOn ist noch in einem Pre-Release-Status für einen selektiven Personenkreis. Verbesserungen etc. werden zum aktuellen Zeitpunkt nur von diesen entgegen genommen. Der vollständige Release geht dann jedoch auch mit einer Support-Struktur einher (i.e. Issue Tracker, usw.)
